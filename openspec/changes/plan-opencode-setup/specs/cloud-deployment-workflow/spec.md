...
- **WHEN** Release agent executes the cloud deployment workflow
...
- **THEN** Release agent blocks completion, alerts PM/Orchestrator, and provides instructions (or automated fixes) so the environment aligns with the approved OpenSpec change.
