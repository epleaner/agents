...
scripts/provision-sprite.sh --name my-dev-env

# With specific organization
scripts/provision-sprite.sh --name my-dev-env --org myorg

# With a specific branch
scripts/provision-sprite.sh --branch feature-xyz
```
...
sprite -s opencode-dev exec "scripts/provision-sprite.sh --inside"
