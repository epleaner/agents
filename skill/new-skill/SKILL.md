...
```bash
ls skill/                              # List existing skills
cat skill/<name>/SKILL.md              # Review similar skills
```
...
### Skill File: `skill/<name>/SKILL.md` (or `.opencode/skill/<name>/SKILL.md` when scaffolded)
```markdown
---
name: <skill-name>
