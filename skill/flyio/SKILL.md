...
- Run: `scripts/deploy-flyio.sh` (or `.opencode/scripts/deploy-flyio.sh` when scaffolded)
...
#### Status Check
- Run: `scripts/deploy-flyio.sh --status`
...
#### Start Machine
- Run: `scripts/deploy-flyio.sh --start`
...
#### Stop Machine
- Run: `scripts/deploy-flyio.sh --stop`
...
#### SSH Connection
- Run: `scripts/deploy-flyio.sh --ssh`
...
#### View Logs
- Run: `scripts/deploy-flyio.sh --logs`
...
#### Destroy App
- Run: `scripts/deploy-flyio.sh --destroy`
...
3. Stop when done to pause billing: `scripts/deploy-flyio.sh --stop`
```
...
- Stop: `scripts/deploy-flyio.sh --stop`
- Logs: `scripts/deploy-flyio.sh --logs`
```
...
3. Stop when done: scripts/deploy-flyio.sh --stop
...
2. Start Machine: scripts/deploy-flyio.sh --start
...
2. **Use the deployment script** - Prefer `scripts/deploy-flyio.sh` over raw flyctl commands for consistency.
...
| `scripts/deploy-flyio.sh` | Deployment automation script |
