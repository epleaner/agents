...
| ML-20260107-003 | Custom deployer needs production safeguards | meta-learnings.md | custom-deployer | promoted | .opencode/agent/custom-deployer.yaml |
| ML-20260107-004 | Test project needs production caution notice | meta-learnings.md | orchestrator | promoted | .opencode/AGENTS.md |
