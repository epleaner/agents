...
- Identify skill catalog updates (e.g., `openspec`, `bd`, `knowledge-graph`, `slack-notify`) required for the Meta-Agent to coordinate cross-team feedback and file follow-up proposals.
