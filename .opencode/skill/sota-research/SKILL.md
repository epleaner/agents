...
- Read `.opencode/skill/sota-research/sources.md` if it exists
...
.opencode/agent/*.md          # Individual agent configurations
.opencode/skill/*/SKILL.md    # Skill definitions
.opencode/command/*.md        # Command definitions
.opencode/openspec/           # Change proposal framework
```
...
Added <N> new sources to tracking. See `.opencode/skill/sota-research/sources.md`.
