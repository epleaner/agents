...
- **Affected code:**
  ...
  - `packages/yepe/src/prompts.ts` - Add detection functions, update prompts with defaults
  - `packages/yepe/src/detect.ts` - New file for project detection logic
  - `packages/yepe/README.md` - Document both commands
