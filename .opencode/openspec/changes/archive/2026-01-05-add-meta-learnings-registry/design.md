...
5. **Learnings as Source of Truth:** Meta learnings live in ledgers/index/AGENTS/specs, providing a structured home for operational insights.
...
4. Extend the `codex-multi-agent-suite` spec with the new requirement and scenarios covering ledger maintenance and review workflow.
