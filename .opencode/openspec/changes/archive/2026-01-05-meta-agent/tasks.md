...
- [x] 1.4 Expand the skill catalog to map `openspec`, `bd`, `knowledge-graph`, and `slack-notify` access for the Meta-Agent, including logging requirements for every improvement action.
